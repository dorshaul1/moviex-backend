...
async function tmdb_getMostUpcomingMovies(page = 2) {
      try {
...
//       try {
//             const images = await axios(`https://api.themoviedb.org/3/movie/${movieId}/images?api_key=${API_KEY}&language=en-US`)
//             return images.data
//       } catch (err) {
//             throw err
//       }
